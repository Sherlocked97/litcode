...
export default function SolutionButtons() {
	return (
		<div className="flex pt-4">
			...
			<div class = "bbg-transparent hover:bg-green-500 text-green-700 font-mono hover:text-white py-0 px-2 border border-green-500 hover:border-transparent rounded">
			<Timer />
			</div>
		</div>
	)
